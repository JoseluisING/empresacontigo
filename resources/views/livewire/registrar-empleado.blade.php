                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text"
                                                ...
                                                wire:model="name" name="name" onkeypress="return sololetras(event)">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" name="ap_p" id="last_name" autocomplete="family-name"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                wire:model="ap_p" onkeypress="return sololetras(event)">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" name="ap_m" id="last_name" autocomplete="family-name"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                wire:model="ap_m" onkeypress="return sololetras(event)">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" name="cedula" id="last_name" autocomplete="family-name"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                wire:model="cedula" onkeypress="return solonumeros(event)"
                                                onKeyUp="return limitar(event,this.value,8)"
                                                onKeyDown="return limitar(event,this.value,8)">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" name="rfc" id="last_name" autocomplete="family-name"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                wire:model="rfc" onKeyUp="return limitar(event,this.value,10)"
                                                onKeyDown="return limitar(event,this.value,13)">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" name="curp" id="last_name" autocomplete="family-name"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                wire:model="curp" onKeyUp="return limitar(event,this.value,18)"
                                                onKeyDown="return limitar(event,this.value,18)">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="date" name="fecha_nacimiento" id="last_name"
                                                ...
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                wire:model="fecha_nacimiento" max="2003-12-31">
