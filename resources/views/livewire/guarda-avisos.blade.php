...
<a href="{{ route('listanNotificacion') }}" class="txt-green-600">
    <div class="flex bg-green-lighter max-w-bg mb-4">
        ...
        <div class="w-auto text-black opacity-75 items-center p-4">
            ...
            <p class="leading-tight">
                Tu respuesta publicada correctamente<br>
                Regresa a los avisos
            </p>
        </div>
    </div>
</a>
